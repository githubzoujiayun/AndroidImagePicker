...
public class MyCameraFragmentLow extends CameraFragment {
	...
	static MyCameraFragmentLow getInstance(boolean useFFC) {
		MyCameraFragmentLow fragment=new MyCameraFragmentLow();
