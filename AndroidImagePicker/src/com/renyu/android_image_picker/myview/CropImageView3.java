package com.renyu.android_image_picker.myview;

import com.renyu.android_image_picker.crop.FloatDrawable;
...
//		super.onDraw(canvas);
	...
	protected void checkBounds()
	{
		...
		if(mDrawableFloat.right>mDrawable.getBounds().left+mDrawable.getBounds().right)
		{
			newLeft=mDrawable.getBounds().left+mDrawable.getBounds().right-mDrawableFloat.width();
			isChange=true;
		}

		if(mDrawableFloat.bottom>mDrawable.getBounds().bottom+mDrawable.getBounds().top)
		{
			newTop=mDrawable.getBounds().bottom+mDrawable.getBounds().top-mDrawableFloat.height();
			isChange=true;
		}
